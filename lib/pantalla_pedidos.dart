...
class _PantallaPedidosState extends State<PantallaPedidos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _currentUser == null ? _buildLoginPrompt() : _buildOrdersStream(),
    );
  }
  ...
  Widget _buildOrderItem(QueryDocumentSnapshot pedidoDoc) {
    ...
    if (pedidoId.contains('-')) {
      ...
      if (partes.isNotEmpty) {
        ...
        pedidoIdCorto =
            ultimaParte.length > 6 ? ultimaParte.substring(0, 6) : ultimaParte;
      }
    } else {
    ...
    IconData estadoIcon = Icons.timer_outlined;
    ...
    } else if (estado == 'Procesando' || estado == 'Enviado') {
      estadoColor = Colors.blue;
      estadoIcon = Icons.local_shipping_outlined;
    } else if (estado == 'Preparando pedido') {
      estadoColor = Colors.amber;
      estadoIcon = Icons.soup_kitchen;
    } else if (estado == 'Listo para recoger') {
      estadoColor = Colors.indigo;
      estadoIcon = Icons.shopping_bag_outlined;
    }
    ...
    return Card(
      ...
      child: InkWell(
        borderRadius: BorderRadius.circular(12),
        onTap: () => _mostrarDetallesPedido(
            context, pedidoData, pedidoIdCorto), // Pasamos el ID corto
        child: Padding(
          padding: const EdgeInsets.all(16.0),
          child: Column(
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  PantallaSoporte(orderId: pedidoId),
                            ),
                          );
                        },
                      ),
                      ...
                      OutlinedButton.icon(
                        ...
                        onPressed: () => _mostrarDetallesPedido(context,
                            pedidoData, pedidoIdCorto), // Pasamos el ID corto
  ...
  void _mostrarDetallesPedido(BuildContext context,
      Map<String, dynamic> pedidoData, String pedidoIdCorto) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...productos.map((producto) {
                      ...
                      final precio =
                          (producto['precio'] as num? ?? 0.0).toDouble();
